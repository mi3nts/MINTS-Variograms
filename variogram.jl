...
function Cgm(df)
    ...
    global plot_df = DataFrame(plot_array_pm01 = Any[],
                        plot_array_pm03 = Any[],
                        plot_array_pm05 = Any[],
                        plot_array_pm10 = Any[],
                        plot_array_pm25 = Any[],
    ...
    for i in 1:10 #10 lags for each pm sensor
        ...
        ##println("head variance: ",head_variance_pm25,)

        # Tail Statistics
        tail_mean_pm25 = mean(df_tail_pm25)
        #println("tail mean: ",tail_mean_pm25)
        ...
        push!(plot_df.plot_array_pm01,Plots.scatter(df_tail_pm01,df_head_pm01,xlabel = "tail pm0.1", ylabel = "head pm0.1",title = topic, label= label_1_pm01*label_2_pm01 ))
        push!(plot_df.plot_array_pm03,Plots.scatter(df_tail_pm03,df_head_pm03,xlabel = "tail pm0.3", ylabel = "head pm0.3",title = topic, label= label_1_pm03*label_2_pm03 ))
        push!(plot_df.plot_array_pm05,Plots.scatter(df_tail_pm05,df_head_pm05,xlabel = "tail pm0.5", ylabel = "head pm0.5",title = topic, label= label_1_pm05*label_2_pm05 ))
        push!(plot_df.plot_array_pm10,Plots.scatter(df_tail_pm10,df_head_pm10,xlabel = "tail pm1.0", ylabel = "head pm1.0",title = topic, label= label_1_pm10*label_2_pm10 ))
        push!(plot_df.plot_array_pm25,Plots.scatter(df_tail_pm25,df_head_pm25,xlabel = "tail pm2.5", ylabel = "head pm2.5",title = topic, label= label_1_pm25*label_2_pm25 ))
        push!(plot_df.plot_array_pm50,Plots.scatter(df_tail_pm50,df_head_pm50,xlabel = "tail pm5.0", ylabel = "head pm5.0",title = topic, label= label_1_pm50*label_2_pm50 ))
        push!(plot_df.plot_array_pm100,Plots.scatter(df_tail_pm100,df_head_pm100,xlabel = "tail pm10.0", ylabel = "head pm10.0",title = topic, label= label_1_pm100*label_2_pm100 ))       
    end
    

    return corr_df, γh_df, time_df, plot_df
end



for plotcol in eachcol(Cgm(df_agg_1)[4])
    display(plot(plotcol..., layout=(5,2), size = (1000,1000)))
    empty!(plotcol)
end

for plotcol in eachcol(Cgm(df_agg_2)[4])
    display(plot(plotcol..., layout=(5,2), size = (1000,1000)))
    empty!(plotcol)
end
...
# CSV.write("C:/Users/va648/VSCode/MINTS-LoRa-Variograms-master/firmware/data/timepf1.csv", Cgm(df_agg_1)[3])
# CSV.write("C:/Users/va648/VSCode/MINTS-LoRa-Variograms-master/firmware/data/timepf2.csv", Cgm(df_agg_2)[3])
# CSV.write("C:/Users/va648/VSCode/MINTS-LoRa-Variograms-master/firmware/data/ypf1.csv", Cgm(df_agg_1)[2])
# CSV.write("C:/Users/va648/VSCode/MINTS-LoRa-Variograms-master/firmware/data/ypf2.csv", Cgm(df_agg_2)[2])
