...
wind_data = read.csv("C:/Users/va648/Downloads/VSCode/MINTS-LoRa-Variograms/firmware/data/daily/jan17.csv")
...
pollutionRose(mydata_sample, pollutant = "pm0.1",main = title,cols = rev_default_col,key.position = "right",
              ...
              key.footer =NULL,
              limits = c(lim[1],lim[2]),par.settings=list(fontsize=list(text=20)))

pollutionRose(mydata_sample,
              pollutant = "pm0.1",
              type = "Temperature",cols = rev_default_col,
              layout = c(2, 2),key.header = TeX('$\\PM_0._1\\ Range\\ (Minutes)$'),
              key.position = "right",par.settings=list(fontsize=list(text=20)))
pollutionRose(mydata_sample,
              pollutant = "pm0.1",
...
pollutionRose(mydata_sample, pollutant = "pm0.1", statistic = "prop.mean",cols = rev_default_col, par.settings=list(fontsize=list(text=20)))
...
polarFreq(mydata_sample, pollutant = "pm0.1", 
           ...
           key.footer =NULL,
          min.bin = 2, par.settings=list(fontsize=list(text=20)))

polarAnnulus(mydata_sample, 
             pollutant = "pm0.1", 
             period = "weekday", 
             main = "Weekday",key.header = "Mean PM0.1 Measurement Time in minutes", par.settings=list(fontsize=list(text=20)))
...
polarAnnulus(mydata_sample, 
             ...
             key.footer = NULL,
             period = "hour", 
             main = "Hour", par.settings=list(fontsize=list(text=20)))
...
#shows which wind dir. contributed the most
pollutionRose(mydata_sample, pollutant = "pm0.3", statistic = "prop.mean",cols = rev_default_col, par.settings=list(fontsize=list(text=20)))
...
# #shows which wind dir. contributed the most
pollutionRose(mydata_sample, pollutant = "pm0.5", statistic = "prop.mean",cols = rev_default_col, par.settings=list(fontsize=list(text=20)))
...
polarAnnulus(mydata_sample, 
             pollutant = "pm0.5", 
             period = "weekday", 
             main = "Weekday",key.header = "Mean PM0.5 Measurement Time in minutes",
             par.settings=list(fontsize=list(text=20)))

polarAnnulus(mydata_sample, 
             pollutant = "pm0.5",
             key.header = "Mean PM0.5 Measurement Time in minutes",
             key.footer = NULL,
             period = "hour", 
             main = "Hour",
             par.settings=list(fontsize=list(text=20)))
...
# #shows which wind dir. contributed the most
pollutionRose(mydata_sample, pollutant = "pm1.0", statistic = "prop.mean",cols = rev_default_col, par.settings=list(fontsize=list(text=20)))
...
polarFreq(mydata_sample, pollutant = "pm1.0", 
           statistic = "weighted.mean", 
           key.header = "Weighted Mean of PM1.0 Measurement Time ", 
           key.footer =NULL,
          min.bin = 2,
          par.settings=list(fontsize=list(text=20)))
...
polarAnnulus(mydata_sample, 
             pollutant = "pm1.0", 
             period = "weekday", 
             main = "Weekday",key.header = "Mean PM1.0 Measurement Time in minutes",
             par.settings=list(fontsize=list(text=20)))
...
#shows which wind dir. contributed the most
pollutionRose(mydata_sample, pollutant = "pm2.5", statistic = "prop.mean",cols = rev_default_col, par.settings=list(fontsize=list(text=20)))
...
polarAnnulus(mydata_sample, 
             pollutant = "pm2.5", 
             period = "weekday", 
             main = "Weekday",key.header = "Mean PM2.5 Measurement Time in minutes", par.settings=list(fontsize=list(text=20)))
...
pollutionRose(mydata_sample,
              pollutant = "pm5.0",
              type = "Temperature",cols = rev_default_col,
              layout = c(2, 2),key.header = TeX('$\\PM_5._0\\ Range\\ (Minutes)$'),
              key.position = "right",par.settings=list(fontsize=list(text=20)))
pollutionRose(mydata_sample,
              pollutant = "pm5.0",
              type = "Pressure",cols = rev_default_col,
...
#shows which wind dir. contributed the most
pollutionRose(mydata_sample, pollutant = "pm5.0", statistic = "prop.mean",cols = rev_default_col, par.settings=list(fontsize=list(text=20)))
...
# weighted mean pm2.5 time scale
polarFreq(mydata_sample, pollutant = "pm5.0", 
           statistic = "weighted.mean", 
           key.header = "Weighted Mean of PM5.0 Measurement Time ", 
           key.footer =NULL,
          min.bin = 2, par.settings=list(fontsize=list(text=20)))
...
polarAnnulus(mydata_sample, 
             pollutant = "pm5.0", 
             period = "weekday", 
             main = "Weekday",key.header = "Mean PM5.0 Measurement Time in minutes", par.settings=list(fontsize=list(text=20)))

polarAnnulus(mydata_sample, 
             pollutant = "pm5.0",
             key.header = "Mean PM5.0 Measurement Time in minutes",
             key.footer = NULL,
             period = "hour", 
             main = "Hour", par.settings=list(fontsize=list(text=20)))
...
pollutionRose(mydata_sample,
              pollutant = "pm10.0",
              type = "Temperature",cols = rev_default_col,
              layout = c(2, 2),key.header = TeX('$\\PM_10._0\\ Range\\ (Minutes)$'),
              key.position = "right",par.settings=list(fontsize=list(text=20)))
pollutionRose(mydata_sample,
              pollutant = "pm10.0",
              type = "Pressure",cols = rev_default_col,
...
# weighted mean pm2.5 time scale
polarFreq(mydata_sample, pollutant = "pm10.0", 
           statistic = "weighted.mean", 
           key.header = "Weighted Mean of PM10.0 Measurement Time ", 
           key.footer =NULL,
          min.bin = 2,
          par.settings=list(fontsize=list(text=20)))
...
polarAnnulus(mydata_sample, 
             pollutant = "pm10.0", 
             period = "weekday", 
             main = "Weekday",key.header = "Mean PM10.0 Measurement Time in minutes",
             par.settings=list(fontsize=list(text=20)))

polarAnnulus(mydata_sample, 
             pollutant = "pm10.0",
             key.header = "Mean PM10.0 Measurement Time in minutes",
             key.footer = NULL,
             period = "hour", 
             main = "Hour",
             par.settings=list(fontsize=list(text=20)))
